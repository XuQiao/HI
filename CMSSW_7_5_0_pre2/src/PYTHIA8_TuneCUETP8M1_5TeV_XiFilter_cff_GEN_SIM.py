...
# with command line options: Configuration/Generator/python/MinBias_8TeV_pythia8_TuneCUETP8M1_cff --condition mc -n 10 --eventcontent RAWSIM -s GEN,SIM --datatier GEN-SIM --beamspot Nominal5TeVpp2015Collision --no_exec
...
process.particlefilter = cms.EDFilter("PythiaFilter",
    ...
    MinPt = cms.untracked.double(2.4),
