...
void getResv2(){
	...
	if(!f_.good()){
	system("hadd merged.root /scratch/xuq7/flow/EPAnalyzer/pPbDataV205m100/Varmultper5s10b10/AnaEP_*.root");	
	}
	...
	for(int ifile=0; ifile<nFileAll; ifile++){
		f[ifile] = TFile::Open(Form("/scratch/xuq7/flow/EPAnalyzer/pPbDataV205m100/Varmultper5s10b10/AnaEP_%d.root",ifile));
