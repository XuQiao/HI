...
const TString dir = "/cms/store/user/qixu/flow/STEGwithnf/pPbDataV205m100/Varmultper5s10b10";
...
const int npt= 9;
const int trkbin[]={150,50};
const int nbin = 1;
const int neta=5;
const double etap[neta]={0,1.0,1.5,2,3};
const double etan[neta]={0,-1.0,-1.5,-2,-3};
const double etac = 0.35;
