...
#include "Run15pAlpc3dphidzcalibsmoothpass1.h"
...
Ridgecntbbc::Ridgecntbbc(TString input, TString input1, TString output):
...
//  float bbc_add = bbc_s + bbc_n;
  ...
  /*
  if(cent <= 1) icent = 0;
  else if(cent <= 5) icent = 1;
  else if(cent <= 10) icent = 2;
  else if(cent <= 20) icent = 3;
  else if(cent <= 30) icent = 4;
  else if(cent <= 40) icent = 5;
  else if(cent <= 60) icent = 6;
  else icent = 7;
...
//  float bbcde_t0[nbbcs];
  ...
  if(bbct0sigmasouth<0.1) icent = 0;
  else if(bbct0sigmasouth<0.2) icent = 1;
  else if(bbct0sigmasouth<0.3) icent = 2;
  else if(bbct0sigmasouth<0.4) icent = 3;
  else if(bbct0sigmasouth<0.5) icent = 4;
  else if(bbct0sigmasouth<0.6) icent = 5;
  else if(bbct0sigmasouth<0.7) icent = 6;
  else icent = 7;
