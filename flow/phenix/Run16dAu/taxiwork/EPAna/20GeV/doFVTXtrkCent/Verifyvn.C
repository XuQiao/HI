...
void Verifyvn(){
    ...
    //TGraphErrors* gr_fvtx1s = new TGraphErrors("../../200GeV/doFVTXlayers/Result/NoUseCNTEP/v2_00_0_BBCS.dat","%lg %lg %lg");
...
leg->AddEntry(grold_fvtx1s,"Run16 0-5\%");
leg->AddEntry(gr[5][idire][iCNTEP],Form("Run16 5-10%% FVTXs as EP"));
leg->AddEntry(gr[4][idire][iCNTEP],Form("Run16 5-10%% BBCS as EP"));
...
h->SetMinimum(0);
h->SetMaximum(2);
SetTitle(h,"","p_{T}","v_{2} ratio 5-10%%/0-5%%");
h->DrawCopy();
