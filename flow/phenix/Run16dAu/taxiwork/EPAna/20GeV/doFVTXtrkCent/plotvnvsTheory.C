...
void plotvnvsTheory(){
    ...
    TGraphErrors *fAMPT = (TGraphErrors*)fth->Get(Form("v%d_200GeV_AMPT",n));
    TGraphErrors *fSONIC = (TGraphErrors*)fth->Get(Form("v%d_200GeV_SONIC",n));
    TGraphErrors *fSSONIC = (TGraphErrors*)fth->Get(Form("v%d_200GeV_superSONIC",n));
...
TLatex t;
t.SetNDC();
t.DrawLatex(0.6,0.75,"d+Au 200GeV");
