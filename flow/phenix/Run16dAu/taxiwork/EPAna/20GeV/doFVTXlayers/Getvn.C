...
//          if(ihar!=1) continue;
       for(int isub=0;isub<nsub;isub++){
        ...
        for(int irun=0;irun<nrun;irun++){
         ...
         fin = TFile::Open(Form("/gpfs/mnt/gpfs02/phenix/plhf/plhf1/xuq/phenix/flow/Run16dAu/work/20GeV/output/%s",GetRun(irun).Data()));
