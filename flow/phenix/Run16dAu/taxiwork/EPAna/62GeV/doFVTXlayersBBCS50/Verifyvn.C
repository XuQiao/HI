...
leg->AddEntry(grold_fvtx1s,"Run16 200GeV","P");
leg->AddEntry(gr[5][idire][iCNTEP],Form("Run16 62GeV FVTX -3.0<#eta<-1.0 as EP"),"P");
leg->AddEntry(gr[4][idire][iCNTEP],Form("Run16 62GeV BBCS as EP"),"P");
