...
void Verifyvn(){
    ...
    TGraphErrors* gr_fvtx1s = new TGraphErrors("../../62GeV/doFVTXlayersfvtxz/Result/NoUseCNTEP/v2_00_0_FVTX1S.dat","%lg %lg %lg");
...
leg->AddEntry(gr_fvtx1s,"Run16 62 GeV 0-5\%","P");
leg->AddEntry(gr[5][idire][iCNTEP],Form("Run16 62GeV 5-10%% FVTX -3.0<#eta<-1.0 as EP"),"P");
leg->AddEntry(gr[4][idire][iCNTEP],Form("Run16 62GeV 5-10\% BBCS as EP"),"P");
...
h->SetMinimum(0);
h->SetMaximum(2);
SetTitle(h,"","p_{T}","v_{2} ratio Run16 62GeV 5-10%%/0-5%%");
h->DrawCopy();
