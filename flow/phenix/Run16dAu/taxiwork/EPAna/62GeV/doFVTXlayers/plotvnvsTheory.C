...
void plotvnvsTheory(){
    ...
    TFile *fth = TFile::Open("/gpfs/mnt/gpfs02/phenix/plhf/plhf1/xuq/phenix/flow/Run16dAu/taxiwork/EPAna/TheoryCurves.root");
    ...
    TFile *fthIP = TFile::Open("/gpfs/mnt/gpfs02/phenix/plhf/plhf1/xuq/phenix/flow/Run16dAu/taxiwork/EPAna/IPGlasma_dAu.root");
