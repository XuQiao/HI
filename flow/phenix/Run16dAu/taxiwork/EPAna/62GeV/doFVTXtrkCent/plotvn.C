...
leg->AddEntry(gr[4][idire][iCNTEP],Form("Run16 62GeV BBCs"),"P");
leg->AddEntry(gr[5][idire][iCNTEP],Form("Run16 62GeV FVTXs cluster -3.0<#eta<-1.0"),"P");
leg->AddEntry(gr[6][idire][iCNTEP],Form("Run16 62GeV FVTXs track -3.0<#eta<-1.0"),"P");
leg->Draw("Psame");
/*
c2->cd(2);
if(n==2){
