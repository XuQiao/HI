...
leg->AddEntry(gr[5][idire][iCNTEP],Form("Run16 39GeV 0-5%% FVTX -3.0<#eta<-1.0 as EP"),"P");
leg->AddEntry(gr[4][idire][iCNTEP],Form("Run16 39GeV 0-5\% BBCS as EP"),"P");
...
h->SetMinimum(0);
h->SetMaximum(2);
SetTitle(h,"","p_{T}","v_{2} ratio Run16 39GeV/Run16 200GeV");
h->DrawCopy();
