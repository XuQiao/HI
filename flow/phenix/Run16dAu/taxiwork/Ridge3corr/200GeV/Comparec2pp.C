...
float Mperbbc[6] = {7.39,7.39,7.39,7.39,7.39,7.39};
float Mbbc[6] = {83.86,60.54,48.24,30.16,16.66,7.39};
}
if(dire=="north"){
float MPPbbc[6] = {0.69,0.69,0.69,0.69,0.69,0.69};
float Mbbc[6]  = {15.50,12.73,11.12,8.47,5.69,3.27};
float Mperbbc[6] = {3.27,3.27,3.27,3.27,3.27,3.27};
}
  float tmp;
...
if(n==3)
  ...
  leg1->AddEntry(grp,Form("A=c_{%d} d+Au 200 GeV, 0-5%%",n),"P");
  leg1->AddEntry(grper,Form("B=c_{%d} d+Au 200 GeV, 60-100%% * %.2f/%.2f",n, Mbbc[5], Mbbc[0]),"P");
