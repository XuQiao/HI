...
//  TString dire="south";
  ...
  TGraphErrors* grp = new TGraphErrors(Form("../../EPAna/200GeV/Result/NoUseCNTEP/v2_0_FVTX1S.dat"),"%lg %lg %lg");
  //TGraphErrors* grp = new TGraphErrors(Form("../../EPAna/200GeV/Result/v2_pt_dAu_00_05_sys.dat"),"%lg %lg %lg");
  //TGraphErrors* grp = new TGraphErrors(Form("../../EPAna/200GeV/Result/NoUseCNTEP/v2_0_FVTXtrkS.dat"),"%lg %lg %lg");
  //TGraphErrors* grp = new TGraphErrors(Form("../../EPAna/200GeV/Result/NoUseCNTEP/v2_0_BBCS.dat"),"%lg %lg %lg");
 
  float pt[25], c2_p[25], ec2_p[25], ept[25], spt[25];
  float ptpp[25], c2_c[25], ec2_c[25];
  float c2_pt0[25], ec2_pt0[25], spt0[25];
 ...
 // c1_1->SetLogy(1);
  ...
  h->GetYaxis()->SetTitle(Form("c_{%d} or v_{%d} scaled",n,n));
  h->DrawCopy();
...
if(n==3)
  ...
  if(dire=="south")
  leg1->AddEntry(grc,Form("Run16 d+Au 200GeV CNT-BBCs"),"");
  else
  leg1->AddEntry(grc,Form("Run16 d+Au 200GeV CNT-FVTXs"),"");
  leg1->AddEntry(grc,Form("c_{%d} cent: 0-5%%",n),"P");
  leg1->AddEntry(grp,Form("v_{%d} FVTXs EP, 0-5%%", n),"P");
  leg1->Draw("same");
  ...
  hr->GetYaxis()->SetTitle(Form("c_{%d} / v_{%d} *%.2f",n,n,scale));
  ...
  t2->SetTextSize(0.10);
//  t2->Draw();
  c1->Print(Form("Compc%dv%d_%s.png",n,n,dire.Data()));
}
