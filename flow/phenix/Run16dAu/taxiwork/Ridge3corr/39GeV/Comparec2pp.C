...
float Mbbc[6] = {58.21,44.28,35.55,24.85,8.87,4.16};
float Mperbbc[6] = {4.16,4.16,4.16,4.16,4.16,4.16};
  }
  if(dire=="north"){
float MPPbbc[6] = {0.69,0.69,0.69,0.69,0.69,0.69};
float Mbbc[6] = {8.58,7.51,6.71,5.58,3.52,2.80};
float Mperbbc[6] = {2.80,2.80,2.80,2.80,2.80,2.80};
  }
  float tmp;
