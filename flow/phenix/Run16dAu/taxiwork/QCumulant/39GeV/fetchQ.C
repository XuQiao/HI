...
void fetchQ(){
  ...
  TFile *fin = TFile::Open("/gpfs/mnt/gpfs02/phenix/plhf/plhf1/xuq/phenix/flow/Run16dAu/work/39GeV/output_wQcumu.root","ReadOnly");
  TFile *fins[nsample];
  for(int isample=0;isample<nsample;isample++){
    fins[isample] = TFile::Open(Form("/gpfs/mnt/gpfs02/phenix/plhf/plhf1/xuq/phenix/flow/Run16dAu/work/39GeV/output_wQcumu_%d.root",isample),"ReadOnly");
  }
