void Writehisto(){
    ...
    name1 = "tree1.lst";
        ...
        PerformTestMB *pl = new PerformTestMB(readline(Form("%s",name.Data()),i), readline(Form("%s",name1.Data()),i), Form("/store/user/qixu/flow/Run16dAu/200GeV/Perform%s_%d.root",trigtype.Data(),i));
        pl->Init();
        pl->Inittree();
        pl->process_event();
        pl->End();
