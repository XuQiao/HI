void Writehisto(){
    ...
    name1 = "tree1.lst";
        ...
        EPAnaRun16alltree *pl = new EPAnaRun16alltree(readline(Form("%s",name.Data()),i), readline(Form("%s",name1.Data()),i), Form("/store/user/qixu/flow/Run16dAu/62GeV/EPAnaFull%s_rcut_%d.root",trigtype.Data(),i));
        pl->Init();
        pl->Inittree();
        pl->SetcalFlag(0);
        pl->process_event();
