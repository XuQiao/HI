#ifndef __RIDGECNTBBCMWG_H__
#define __RIDGECNTBBCMWG_H__
...
class Ridgecntbbc
{
 public:
  ...
  Ridgecntbbc(TString input = "",TString input1="",TString input2="",TString output="rpanase.root");
  ~Ridgecntbbc();
