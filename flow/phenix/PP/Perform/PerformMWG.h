#ifndef __PERFORMMWG_H__
#define __PERFORMMWG_H__
...
class PerformMWG
{
 public:
  ...
  PerformMWG(TString input = "", TString input1 = "", TString input2 = "",TString output="rpanase.root");
  ~PerformMWG();
