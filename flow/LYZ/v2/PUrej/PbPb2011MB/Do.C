...
void dofirst(){
	...
	for(int i=start;i<end;i++){
		if(SumorProd=="Sum")	name=Form("/scratch/xuq7/flow/pbsjoboutput/PbPb2011MB/PUrej/AnaV_Sum_%d.root",i);
		else	name=Form("/scratch/xuq7/flow/pbsjoboutput/PbPb2011MB/PUrej/AnaV_Prod_%d.root",i);
		remove(name.Data());
...
void dosecond(){
	string SumorProd=getenv("SUMORPROD");
        ...
        TString name;
        for(int i=start;i<end;i++){
                if(SumorProd=="Sum")       name=Form("/scratch/xuq7/flow/pbsjoboutput/PbPb2011MB/PUrej/Anav_Prod_%d.root",i);
                else            name=Form("/scratch/xuq7/flow/pbsjoboutput/PbPb2011MB/PUrej/Anav_Prod2_%d.root",i);
                remove(name.Data());
                LYZ *l = new LYZ(readline("filelist.dat",i));
                cout<<"start "<<i<<" th job"<<endl;
                l->beginJob(1);
...
void dosecondsub(){
	...
	TFile *inf;
   	if(SumorProd=="Sum")       infname="mergedV_Sum_sub.root";
        ...
        for(int i=start;i<end;i++){
                if(SumorProd=="Sum")       name=Form("/scratch/xuq7/flow/pbsjoboutput/PbPb2011MB/PUrej/Anav_Prod_sub_%d.root",i);
                else            name=Form("/scratch/xuq7/flow/pbsjoboutput/PbPb2011MB/PUrej/Anav_Prod2_sub_%d.root",i);
                remove(name.Data());
                LYZ *l = new LYZ(readline("filelist.dat",i));
                cout<<"start "<<i<<" th job"<<endl;
                l->beginJob(1);
...
void dothird(){
        ...
        TString name;
        for(int i=start;i<end;i++){
                if(SumorProd=="Sum")       name=Form("/scratch/xuq7/flow/pbsjoboutput/PbPb2011MB/PUrej/Anaveta_Prod_%d.root",i);
                else            name=Form("/scratch/xuq7/flow/pbsjoboutput/PbPb2011MB/PUrej/Anaveta_Prod2_%d.root",i);
                remove(name.Data());
                LYZ *l = new LYZ(readline("filelist.dat",i));
                cout<<"start "<<i<<" th job"<<endl;
                l->beginJob(0);
