...
void TGlauNucleus::Lookup(const char* name)
{
  ...
  else if (TString(name) == "Al")   {fN = 27; fR = 3.07;     fA = 0.519;   fW =  0;        fF = 1; fZ=13;} //http://faculty.virginia.edu/ncd/dldata/tabletr.txt
  else if (TString(name) == "Al2")   {fN = 27; fR = 2.84;     fA = 0.569;   fW =  0;        fF = 1; fZ=13;}
  else {
